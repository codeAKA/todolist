...
function changeArrowListener() {
    let ev = this;
    if (ev.classList.contains("edit")) {
        let task = ev.parentNode.parentNode;
...
createTaskBtn.addEventListener('click', changeArrowListener);
